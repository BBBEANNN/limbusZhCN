...
public class VPackageManager {
    ...
    public PackageInfo getPackageInfo(String packageName, int flags, int userId) {
        try {
            ...
            PackageInfo fallback = getCurrentLimbusPackageInfoFallback(packageName);
            if (fallback != null) {
                Log.w("VPackageManager", "getPackageInfo fallback for Limbus after remote failure: " + e);
                return fallback;
            }
            return VirtualRuntime.crash(e);
        }
    ...
    private PackageInfo getCurrentLimbusPackageInfoFallback(String packageName) {
        ...
        ApplicationInfo appInfo = client.getCurrentApplicationInfo();
        if (appInfo == null) {
            return null;
        }
