...
public class GmsSupport {
    ...
    public static void installLimbusCoreGms(int userId) {
        HashSet<String> corePackages = new HashSet<>();
        corePackages.add(GMS_PKG);
        corePackages.add(GSF_PKG);
        installPackages(corePackages, userId);
    }
