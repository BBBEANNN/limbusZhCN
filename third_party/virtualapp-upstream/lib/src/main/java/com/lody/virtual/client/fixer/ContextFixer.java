...
public class ContextFixer {
    ...
    public static void fixContext(Context context) {
        ...
        if (ContextImpl.mPackageManager != null) {
        ...
        if (ContextImpl.mBasePackageName != null) {
            ...
            String basePackage = "com.google.android.gms".equals(currentPackage)
                    ? currentPackage
                    : hostPkg;
            ContextImpl.mBasePackageName.set(context, basePackage);
            if (!hostPkg.equals(basePackage)) {
                Log.i("LimbusVA", "Preserved virtual GMS basePackageName=" + basePackage
                        + " while opPackageName remains host=" + hostPkg);
            }
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && ContextImplKitkat.mOpPackageName != null) {
            ContextImplKitkat.mOpPackageName.set(context, hostPkg);
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2 && ContentResolverJBMR2.mPackageName != null) {
