...
//        }
    ...
    public static void clearVAData(Intent sender) {
        ...
        if (sender.hasExtra("_VA_|_ext_")) {
            sender.removeExtra("_VA_|_ext_");
        }
        if (sender.hasExtra("_VA_|_sender_")) {
            sender.removeExtra("_VA_|_sender_");
        }
        if (sender.hasExtra("_VA_|_sender_key_")) {
            sender.removeExtra("_VA_|_sender_key_");
        }
    }
